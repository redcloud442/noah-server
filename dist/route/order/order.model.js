...
export const orderGetItemsModel = async (params) => {
    ...
    const formattedOrderItems = orderItems.flatMap((order) => order.order_items.map((item) => ({
        ...
        product_variant_name: item.product_variant.product_variant_product.product_name,
        product_variant_image: item.product_variant.variant_sample_images.length > 0
